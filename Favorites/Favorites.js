...
async function getData(movieID) {
    const result = await fetch(`https://www.omdbapi.com/?i=${movieID}&apikey=dcc7d36`); //Get data from API
...
const AddMovie = (details) => {
    ...
    btn.innerHTML = `<i data-id="${details.imdbID}" class="fa-solid fa-trash-can">`; //Set unique id to delete exact movie     
